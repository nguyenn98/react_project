    ...
    return (
        <div>
            ...
            <div className='mt-8' style={{ width: '70%', marginLeft: '302px' }} >
                <p className='ml-2.5 font-medium dark:text-slate-300 text-stone-700 tracking-wide leading-7'
                ...
                <div className='flex justify-start mt-28'>
                    <h2 className='text-4xl dark:text-slate-100 text-stone-950 font-semibold mb-4'
                        style={{ width: '300px' }}>
                        Our Mission
                    </h2>
                    <div className='ml-20'>
                        <div>
                            <h4 className='dark:text-slate-200 text-3xl mb-3'>Long term strategy</h4>
                        ...
                        <div>
                            <h4 className='text-3xl dark:text-slate-200'>Client Satisfaction</h4>
                            <p className='font-medium dark:text-slate-300 text-stone-700 tracking-wide leading-7'
                                style={{ fontSize: '16.5px', fontFamily: 'sans-serif', width: '540px' }}>
                                Met gradually two client refinements. Royal to another all if, fly dressed and
                                of maybe function. Stash should ruining me rationalize to the as seven there
            ...
            <div className='text-center mt-24' style={{ width: '50%', marginLeft: '25%' }}>
                <h2 className='dark:text-slate-100 -ml-4' style={{ fontSize: '36px' }}>Testimonials</h2>
                <BsQuote className='w-10 h-10 dark:text-[#7b75e2] text-indigo-900 mt-5' style={{ marginLeft: '300px' }} />
                <p className='font-semibold dark:text-slate-300 text-stone-700 tracking-wider leading-7 mt-3.5'
                    style={{ fontSize: '22px', fontFamily: 'sans-serif', width: '540px', marginLeft: '60px' }}>
                    Your Quality is top notch
                </p>
                <p className='font-semibold dark:text-[#535199] text-indigo-900 tracking-wider leading-7 mt-4'
                    style={{ fontSize: '16px', fontFamily: 'sans-serif', width: '540px', marginLeft: '60px' }}>
                    – Loyal Customer
                </p>
                <p className='font-medium dark:text-zinc-300 text-stone-700 tracking-wide leading-7 mt-5'
