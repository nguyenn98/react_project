  ...
  return (
    <div style={{ backgroundColor: '#fffefc' }}>
      <div className='flex items-center justify-start' style={{ width: '100%' }}>
        <h1 className='text-center mt-5 text-5xl text-slate-900' style={{ width: '50%' }}>
          About Me
        </h1>
        <img style={{ width: '50%', height: '100vh' }} src={about_me} alt={about_me} />
      </div>
      <div className='flex mt-20 ml-32' style={{ width: '84%' }} >
        <div className='mr-36'>
          <h2 className='text-4xl text-stone-950 font-semibold mb-4'>Hello,</h2>
          <h2 className='text-4xl text-stone-950 font-semibold'>This is Mully.</h2>
        </div>
        <p className='mr-6 font-medium text-stone-700 tracking-wide leading-7'
