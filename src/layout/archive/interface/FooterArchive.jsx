...
import style_wit_white from '../images/style_wit_white.png'

import { Link } from 'react-router-dom'

const FooterArchive = () => {
    return (
        <div className='dark:bg-stone-900 bg-neutral-900 text-slate-50'>
            <div className='flex pt-16 shadow-sm shadow-neutral-900'
                ...
                <div className='tracking-wide mt-1' style={{ width: '440px', marginLeft: '75px', }}>
                    <img src={style_wit_white} alt={style_wit_white} className='mb-7'
