...
const Loremipsum = () => {
    return (
        <div>
            <p className='tracking-wide leading-8 dark:text-neutral-300 dark:opacity-95 text-neutral-700 mt-4' style={{ fontSize: '16.9px' }}>
            ...
            <p className='tracking-wide leading-8 dark:text-neutral-300 dark:opacity-95 text-neutral-700 mt-4' style={{ fontSize: '16.8px' }}>
                Rhoncus dolor purus non enim. Ultrices gravida
                <Link className='no-underline px-1 dark:text-[#6d6abb] dark:hover:text-neutral-300 text-blue-900 hover:text-neutral-600 transition ease-in-out duration-200'
            ...
            <div className='leading-9 tracking-wider font-sans font-medium mt-14 ml-8'
                ...
                <FaQuoteLeft className='dark:text-[#535199] text-[#312e81] dark:opacity-95 mb-4 w-7 h-7' />
                <p className='dark:text-neutral-300 dark:opacity-95'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Venenatis urna cursus eget nunc scelerisque.</p>
                <p className='text-base dark:text-[#6c69c9] text-[#312e81] dark:opacity-95'>– Luca Maxwell</p>
            </div>
            <p className='tracking-wide leading-7 dark:text-neutral-300 dark:opacity-95 text-neutral-600 mt-5 font-medium'
                ...
                <Link className='no-underline px-1 dark:text-[#615fad] dark:hover:text-neutral-300 text-blue-900 hover:text-neutral-600 transition ease-in-out duration-200'
                    to='https://www.google.com/'>
                    sapien pellentesque
                </Link>
            ...
            <div>
                ...
                <p className='text-xs dark:text-neutral-300 dark:opacity-95 mt-3 tracking-wider' style={{ marginLeft: '305px' }}>
                    Image caption text
                </p>
            </div>
            <p className='tracking-wide leading-7 dark:text-neutral-300 dark:opacity-95 text-neutral-700 mt-4' style={{ fontSize: '16.8px' }}>
            ...
            <h2 className='font-semibold leading-snug dark:text-neutral-300 dark:opacity-95' style={{ fontSize: '35px', marginTop: '38px' }}>Heading that grabs visitors attention for a list of interesting things</h2>
            <p className='tracking-wider dark:text-neutral-300 dark:opacity-95 text-stone-700 leading-8'
            ...
            <ul className='dark:text-neutral-300 dark:opacity-95 tracking-wider leading-7 list-disc ml-5' style={{ fontSize: '16.5px', marginBottom: '28px' }}>
            ...
            <p className='tracking-wide leading-7 dark:text-neutral-300 dark:opacity-95 text-stone-600' style={{ fontSize: '16.8px', marginBottom: '28px', width: '700px' }}>
            ...
            <p className='tracking-wide dark:text-neutral-300 dark:opacity-95' style={{ fontSize: '16.5px', marginBottom: '28px' }}>
                Rhoncus dolor purus non enim. Ultrices gravida dictum fusce ut placerat orci.
            </p>
            <div className='big_title' style={{ height: '430px' }}>
                <h2 className='z-10 dark:opacity-95 text-slate-50 font-normal tracking-wide'
